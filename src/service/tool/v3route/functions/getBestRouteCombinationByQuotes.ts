...
import {getPoolAddress, isV2Pool, isV3Pool} from "../utils/pool";
...
function findFirstRouteNotUsingUsedPools(usedRoutes: RouteWithQuote[], candidateRouteQuotes: RouteWithQuote[]): RouteWithQuote | null {
